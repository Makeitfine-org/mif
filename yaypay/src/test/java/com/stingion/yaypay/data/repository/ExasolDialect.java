 ...
 */
@SuppressWarnings({"all", "deprecation", "CPD-START"})
@SuppressFBWarnings({"SIC_INNER_SHOULD_BE_STATIC_ANON", "DM_BOXED_PRIMITIVE_FOR_PARSING",
...
public class ExasolDialect extends Dialect {
        ...
        public String doExtractConstraintName(SQLException sqle) {
            try {
                ...
                switch (sqlState) {
                    ...
                    // NOT NULL VIOLATION
                    case 23502:
                        return extractUsingTemplate("null value in column \"", "\" violates not-null constraint",
                                sqle.getMessage());
    ...
    public ExasolDialect() {
        ...
        // Date or timestamp depending on the parameter
